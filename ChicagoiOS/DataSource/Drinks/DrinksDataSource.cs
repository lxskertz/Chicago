...
{
    public class DrinksDataSource : UITableViewSource
    {
        ...
        /// </summary>
        private BusinessDrinksController Controller { get; set; }

        #endregion

        #region Constructors

        public DrinksDataSource(BusinessDrinksController controller, List<BusinessDrink> drinks)
        {
